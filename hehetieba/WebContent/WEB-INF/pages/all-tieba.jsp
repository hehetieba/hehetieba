					...
					success : function(data) {
						if (data.pager.totalRecord == 0)
							...
							for (i = 0; i < data.pager.totalRecord; i++) {
								...
								$(".clear").before(
							"<li><a href='#'><img src='images/"+data.pager.datas[i].bgImg+"' /> <p><span>"+data.pager.datas[i].tiebaName+"吧</span><i class='icon-comment'>&nbsp;"+data.pager.datas[i].tieCount+"</i><i class='icon-user'>&nbsp;"+data.pager.datas[i].memberCount+"</i></p></a></li>");
